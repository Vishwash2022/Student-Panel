...
def searchcourse(request):
    ...
    e=Courses.objects.get(Course_name=find)
    return render(request,'courses.html',{'data':[e]})     
...
def searchstudent(request):
    find=request.POST['name']
    s=Student.objects.filter(Q(Student_Name=find) | Q(Student_email=find) | Q(Student_college=find)).all()
